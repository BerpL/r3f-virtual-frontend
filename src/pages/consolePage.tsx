...
export function ConsolePage() {
  ...
  const sendLastAudioItem = async (lastItem: any) => {
    ...
    const message = lastItem.content[0].transcript;
      ...
      if (isLoaded) {
        ...
        if (clientCanvas) {
          ...
          if (clientCtx) {
            ...
            // console.log("result client canvas: ", result);
          }
        }
        if (serverCanvas) {
          // console.log("server Canvas");
    ...
    client.addTool(
      {
        name: "get_knowledge",
        description:
          "Obtiene información ante cualquier consulta de tecsup como carreras, historia, consultria o programas  indicando al usuario que espere un momento que hara una consulta a la base de conocimientos",
        parameters: {
          type: "object",
          properties: {
            query: {
